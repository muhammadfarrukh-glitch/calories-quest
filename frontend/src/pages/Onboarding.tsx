...
const Onboarding = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const userProfile: UserProfile = values;
    const dailyCalorieTarget = calculateDailyCalorieTarget(userProfile);
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button type="submit" className="w-full">Complete Setup & Start Quest</Button>
            </form>
          </Form>
        </CardContent>
      </Card>
